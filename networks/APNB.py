...
class APNB(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, key_channels, value_channels, dropout, sizes=([1]), norm_type=None,psp_size=(1,3,6,8)):
        ...
        self.conv_bn_dropout = nn.Sequential(
            nn.Conv2d(768, out_channels, kernel_size=1, padding=0),
...
if __name__ == '__main__':
    input = Variable(torch.randn(2, 512, 30, 54)).cuda()
    net = APNB(in_channels=512, out_channels=256, key_channels=256, value_channels=256,
